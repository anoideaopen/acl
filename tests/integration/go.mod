...
require (
	github.com/anoideaopen/acl v0.1.2
	github.com/anoideaopen/foundation v0.1.7
	github.com/anoideaopen/foundation/test/integration v0.0.0-20260304155126-115358c12417
...
require (
	...
	github.com/anoideaopen/robot v0.1.1 // indirect
