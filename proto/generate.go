...
//counterfeiter:generate -o ../test/unit/mock/chaincode_stub.go --fake-name ChaincodeStub . chaincodeStub
type chaincodeStub interface { //nolint:unused
	shim.ChaincodeStubInterface
}

//counterfeiter:generate -o ../test/unit/mock/state_iterator.go --fake-name StateIterator . stateIterator
